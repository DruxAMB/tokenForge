  ...
  const feature = [
    {
      ...
      description:
        "Commence your journey with the Solana Genius Token Creator, empowering you to seamlessly craft Solana tokens through functionalities including creation, deployment, airdrops, transfers, and metadata updates.",
  ...
  return (
    <section className="py-20 bg-slate-800">
      <div className="container">
        ...
        <div className="bg-slate-900 flex flex-wrap items-center rounded-3xl backdrop-blur-3xl">
