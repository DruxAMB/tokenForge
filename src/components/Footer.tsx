...
export const Footer: FC = () => {
  ...
  ///
  return (
    <footer className="bg-slate-850 backdrop-blur-3xl">
                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="bg-slate-850 pe-40 ps-4 h-12 w-full rounded-lg border-white/10 py-4 text-white backdrop-blur-3xl focus:border-white/10 focus:ring-0"
                      placeholder="Enter your email :"
                    />
                    <button
                      type="submit"
                      disabled={state.submitting}
                      className="rounded-md bg-gradient-to-tr from-[#9945FF] to-[#14F195] hover:from-[#9945ffb7]  hover:to-[#14f195b2] hover:border-slate-500 border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 px-6 text-white transition-all"
                    >
                      Subscribe
                    </button>
                  </div>
                  ...
                  <ul className="flex flex-wrap items-center gap-1">
                    {[
                      ...
                      <li key={index}>
                        <a
                          href="#"
                          className="hover:bg-slate-850 inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 transition-all duration-500"
                        >
                          <i
        ...
        <div className="md:text-start container flex h-full flex-wrap items-center justify-center gap-4 text-center md:justify-between lg:px-20">
          <p className="text-default-200 text-base font-medium">
            ...
            <a href="#">
              ...
              <i
                data-lucide="heart"
                className="mx-1 inline h-4 w-4 text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]"
              >
                ©tokenForge
              </i>
            </a>
