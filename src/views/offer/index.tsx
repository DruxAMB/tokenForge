            ...
            <div className="container">
                <div className="mb-10 flex items-end justify-between">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        Start working with tokenForge, It allows you to create
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    <div className="space-y-6">
                        <div className="bg-slate-800 hover:translate-y-2  border-s-2 rounded-xl backdrop-blur-3xl transition-all duration-500">
                            <div className="p-10">
                                ...
                                tokenForge simplifies the process of creating Solana tokens, allowing you to define parameters such as name, symbol, and supply effortlessly.
                                </p>
                                <a
                                href="#"
                                className="text-slate-400 group relative inline-flex items-center gap-2"
                                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 hover:translate-y-2  border-s-2 rounded-xl backdrop-blur-3xl transition-all duration-500">
                            <div className="p-10">
                                <i data-lucid="file-text" className="text-primary h-10 w-10"></i>
                                <h3 className="mb-4 mt-8 text-2xl font-medium text-white">
